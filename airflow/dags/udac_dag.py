...
from airflow.operators import (StageToRedshiftOperator, LoadFactOperator,
                                LoadDimensionOperator, DataQualityOperator, PostgresOperator, DataQualityOperatorSpecific)
...
run_qualiy_checks_general = DataQualityOperator(
    task_id="General_Data_quality_check",
    dag=dag,
    redshift_conn_id="redshift",
     tables_list=["users","songs"]
)

run_quality_checks_songs = DataQualityOperatorSpecific(
...
run_quality_checks_artists = DataQualityOperatorSpecific(
...
run_quality_checks_songplays = DataQualityOperatorSpecific(
...
run_quality_checks_users = DataQualityOperatorSpecific(
...
run_quality_checks_time = DataQualityOperatorSpecific(
