...
class DataQualityOperatorSpecific(BaseOperator):
    ...
    def __init__(self,
        ...
        super(DataQualityOperatorSpecific, self).__init__(*args, **kwargs)
        # Map params here
    ...
    def execute(self, context):
        ...
        sql_formatted_staging = DataQualityOperatorSpecific.count_sql_staging.format(
                self.insert_query
            )
        sql_formatted_dimfact = DataQualityOperatorSpecific.count_sql_dimfact.format(
            self.table_star
        )
